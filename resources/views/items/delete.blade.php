...
<div class="row gy-3">
    ...
    <div>
        ...
        <div>
            <button class="btn btn-danger" formaction="{{ route ('items.destroy',[$item->id,'destroy']) }}" type="submit">TAK</button>
            <button class="btn btn-warning" formaction="{{ route ('items.index')}}" type="submit" formmethod="GET">NIE</button>
